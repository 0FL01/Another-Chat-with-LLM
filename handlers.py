...
from utils import format_html, split_long_message, search_with_langchain, is_user_allowed, add_allowed_user, remove_allowed_user, set_user_auth_state, get_user_auth_state
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        '<b>Привет!</b> Я бот, который может отвечать на вопросы и искать информацию. Выберите действие:',
...
async def process_message(update: Update, context: ContextTypes.DEFAULT_TYPE, text: str):
    ...
    search_results = search_with_langchain(text)
